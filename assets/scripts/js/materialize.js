...
(function(r) {
  ...
  function U(a) {
    ...
    let d = /hsl\((\d+),\s*([\d.]+)%,\s*([\d.]+)%\)/g.exec(a) || /hsla\((\d+),\s*([\d.]+)%,\s*([\d.]+)%,\s*([\d.]+)\)/g.exec(a);
    a = parseInt(d[1]) / 360;
    let b = parseInt(d[2]) / 100,
      f = parseInt(d[3]) / 100;
    d = d[4] || 1;
    if (0 == b) f = b = a = f;
    else {
  ...
  function X(a, c) {
    ...
    a = a.style.transform;
    if (!a) return d;
    for (let b = [], f = [], n = [], k = /(\w+)\((.+?)\)/g; b = k.exec(a);) {
  ...
  function M(a) {
    a = a.points;
    for (let c = 0, d, b = 0; b < a.numberOfItems; b++) {
      let f = a.getItem(b);
      0 < b && (c += F(d, f));
      d = f;
    }
  ...
  function q(a) {
    ...
    function b(a) {
      for (let b = 0, c = {}, d = g.animations, f = d.length; b < f;) {
        ...
        for (let h = Math.min(Math.max(a - l.start - l.delay, 0), l.duration) / l.duration, w = isNaN(h) ? 1 : l.easing(h, l.elasticity); h = l.to.strings, p = l.round, n = [], m = void 0, m = l.to.numbers.length, t = 0; t < m, t++) {
          let x = void 0;
          x = l.to.numbers[t],
            q = l.from.numbers[t],
    ...
    g.pause = function() {
      let a = v.indexOf(g); - 1 < a && v.splice(a, 1);
      g.paused = !0;
    };
    g.play = function() {
      ...
      return function(c, d, b, f) {
        if (0 <= c && 1 >= c && 0 <= b && 1 >= b) {
          ...
          return function(k) {
            ...
            if (0 === k) return 0;
            if (1 === k) return 1;
            for (let h = 0, l = 1; 10 !== l && e[l] <= k; ++l) {
              h += .1;
            }--l;
            let l = h + (k - e[l]) / (e[l + 1] - e[l]) * .1,
...
(function($, anim) {
  ...
  let Collapsible = function(_Component) {
    ...
    function Collapsible(el, options) {
      ...
      let _this3 = _possibleConstructorReturn(this, (Collapsible.__proto__ || Object.getPrototypeOf(Collapsible)).call(this, Collapsible, el, options));
      ...
      // Open first active
      let $activeBodies = _this3.$el.children('li.active').children('.collapsible-body');
...
(function($, anim) {
  ...
  let Dropdown = function(_Component2) {
    _inherits(Dropdown, _Component2);

    function Dropdown(el, options) {
      _classCallCheck(this, Dropdown);

      let _this8 = _possibleConstructorReturn(this, (Dropdown.__proto__ || Object.getPrototypeOf(Dropdown)).call(this, Dropdown, el, options));
...
(function($, anim) {
  ...
  let Modal = function(_Component3) {
    ...
    function Modal(el, options) {
      ...
      let _this12 = _possibleConstructorReturn(this, (Modal.__proto__ || Object.getPrototypeOf(Modal)).call(this, Modal, el, options));
...
(function($, anim) {
  ...
  let Materialbox = function(_Component4) {
    ...
    function Materialbox(el, options) {
      ...
      let _this15 = _possibleConstructorReturn(this, (Materialbox.__proto__ || Object.getPrototypeOf(Materialbox)).call(this, Materialbox, el, options));
...
(function($) {
  ...
  let Parallax = function(_Component5) {
    _inherits(Parallax, _Component5);

    function Parallax(el, options) {
      _classCallCheck(this, Parallax);

      let _this20 = _possibleConstructorReturn(this, (Parallax.__proto__ || Object.getPrototypeOf(Parallax)).call(this, Parallax, el, options));
...
(function($, anim) {
  ...
  let Tabs = function(_Component6) {
    ...
    function Tabs(el, options) {
      ...
      let _this21 = _possibleConstructorReturn(this, (Tabs.__proto__ || Object.getPrototypeOf(Tabs)).call(this, Tabs, el, options));
    ...
    _createClass(Tabs, [{
      ...
      value: function _handleTabClick(e) {
        ...
        // Update the letiables with the new link and content
...
(function($, anim) {
  ...
  let Tooltip = function(_Component7) {
    ...
    function Tooltip(el, options) {
      ...
      let _this25 = _possibleConstructorReturn(this, (Tooltip.__proto__ || Object.getPrototypeOf(Tooltip)).call(this, Tooltip, el, options));
...
(function($, anim) {
  ...
  let Sidenav = function(_Component8) {
    ...
    function Sidenav(el, options) {
      ...
      let _this30 = _possibleConstructorReturn(this, (Sidenav.__proto__ || Object.getPrototypeOf(Sidenav)).call(this, Sidenav, el, options));
      ...
      // Window size letiables for window resize checks
    ...
    _createClass(Sidenav, [{
      ...
      /**
       * Set letiables needed at the beggining of drag
      ...
      /**
       * Set letiables needed at each drag move update tick
       * @param {Event} e
       */
      ...
      value: function _handleDragTargetDrag(e) {
        ...
        // If not being dragged, set initial drag start letiables
        if (!this.isDragged) {
          this._startDrag(e);
        }
...
(function($, anim) {
  ...
  let ScrollSpy = function(_Component9) {
    ...
    function ScrollSpy(el, options) {
      ...
      let _this34 = _possibleConstructorReturn(this, (ScrollSpy.__proto__ || Object.getPrototypeOf(ScrollSpy)).call(this, ScrollSpy, el, options));
    ...
    _createClass(ScrollSpy, [{
      ...
      value: function _handleWindowScroll() {
        ...
        for (let _i = 0; _i < ScrollSpy._elementsInView.length; _i++) {
          ...
          let _lastTick = _scrollspy.tickId;
...
(function($) {
  ...
  let Autocomplete = function(_Component10) {
    ...
    function Autocomplete(el, options) {
      ...
      let _this36 = _possibleConstructorReturn(this, (Autocomplete.__proto__ || Object.getPrototypeOf(Autocomplete)).call(this, Autocomplete, el, options));
...
(function($, anim) {
  ...
  let Slider = function(_Component11) {
    ...
    function Slider(el, options) {
      ...
      let _this39 = _possibleConstructorReturn(this, (Slider.__proto__ || Object.getPrototypeOf(Slider)).call(this, Slider, el, options));
...
(function($) {
  ...
  let Chips = function(_Component12) {
    ...
    function Chips(el, options) {
      ...
      let _this44 = _possibleConstructorReturn(this, (Chips.__proto__ || Object.getPrototypeOf(Chips)).call(this, Chips, el, options));
    ...
    _createClass(Chips, [{
      ...
      value: function _handleChipsKeydown(e) {
        ...
        if (e.keyCode === 8 || e.keyCode === 46) {
          ...
          if (currChips._selectedChip) {
            let _selectIndex = currChips._selectedChip.index() - 1;
            if (_selectIndex < 0) {
              return;
            }
          ...
          if (currChips._selectedChip) {
            let _selectIndex2 = currChips._selectedChip.index() + 1;
...
(function($) {
  ...
  let Pushpin = function(_Component13) {
    ...
    function Pushpin(el, options) {
      ...
      let _this46 = _possibleConstructorReturn(this, (Pushpin.__proto__ || Object.getPrototypeOf(Pushpin)).call(this, Pushpin, el, options));
...
(function($, anim) {
  ...
  let FloatingActionButton = function(_Component14) {
    ...
    function FloatingActionButton(el, options) {
      ...
      let _this47 = _possibleConstructorReturn(this, (FloatingActionButton.__proto__ || Object.getPrototypeOf(FloatingActionButton)).call(this, FloatingActionButton, el, options));
...
(function($) {
  ...
  let Datepicker = function(_Component15) {
    ...
    function Datepicker(el, options) {
      ...
      let _this52 = _possibleConstructorReturn(this, (Datepicker.__proto__ || Object.getPrototypeOf(Datepicker)).call(this, Datepicker, el, options));
      ...
      let defDate = _this52.options.defaultDate;
    ...
    _createClass(Datepicker, [{
      ...
      value: function toString(format) {
        ...
        let formattedDate = formatArray.map(function(label) {
...
(function($) {
  ...
  let Timepicker = function(_Component16) {
    _inherits(Timepicker, _Component16);

    function Timepicker(el, options) {
      _classCallCheck(this, Timepicker);

      let _this56 = _possibleConstructorReturn(this, (Timepicker.__proto__ || Object.getPrototypeOf(Timepicker)).call(this, Timepicker, el, options));
    ...
    _createClass(Timepicker, [{
      ...
      value: function _pickerSetup() {
        let $clearBtn = $("<button class=\"btn-flat timepicker-clear waves-effect\" style=\"visibility: hidden;\" type=\"button\" tabindex=\"" + (this.options.twelveHour ? '3' : '1') + "\">" + this.options.i18n.clear + "</button>").appendTo(this.footer).on('click', this.clear.bind(this));
        if (this.options.showClearBtn) {
          $clearBtn.css({
            visibility: ''
          });
...
(function($) {
  ...
  let CharacterCounter = function(_Component17) {
    ...
    function CharacterCounter(el, options) {
      ...
      let _this60 = _possibleConstructorReturn(this, (CharacterCounter.__proto__ || Object.getPrototypeOf(CharacterCounter)).call(this, CharacterCounter, el, options));
...
(function($) {
  ...
  let Carousel = function(_Component18) {
    ...
    function Carousel(el, options) {
      ...
      let _this61 = _possibleConstructorReturn(this, (Carousel.__proto__ || Object.getPrototypeOf(Carousel)).call(this, Carousel, el, options));
      ...
      value: function _scroll(x) {
        ...
        for (i = 1; i <= half; ++i) {
          ...
          if (!this.noWrap || this.center + i < this.count) {
            ...
            let _transformString = alignment + " translateX(" + (this.options.shift + (this.dim * i - delta) / 2) + "px) translateZ(" + zTranslation + "px)";
          ...
          if (!this.noWrap || this.center - i >= 0) {
            el = this.images[this._wrap(this.center - i)];
            let _transformString2 = alignment + " translateX(" + (-this.options.shift + (-this.dim * i - delta) / 2) + "px) translateZ(" + zTranslation + "px)";
        ...
        if (!this.noWrap || this.center >= 0 && this.center < this.count) {
          el = this.images[this._wrap(this.center)];
          let _transformString3 = alignment + " translateX(" + -delta / 2 + "px) translateX(" + dir * this.options.shift * tween + "px) translateZ(" + this.options.dist * tween + "px)";
...
(function($) {
  ...
  let TapTarget = function(_Component19) {
    ...
    function TapTarget(el, options) {
      ...
      let _this66 = _possibleConstructorReturn(this, (TapTarget.__proto__ || Object.getPrototypeOf(TapTarget)).call(this, TapTarget, el, options));
...
(function($) {
  ...
  let FormSelect = function(_Component20) {
    ...
    function FormSelect(el, options) {
      ...
      let _this67 = _possibleConstructorReturn(this, (FormSelect.__proto__ || Object.getPrototypeOf(FormSelect)).call(this, FormSelect, el, options));
      ...
      value: function _setupDropdown() {
          ...
          this.$selectOptions.each(function(el) {
            if ($(el).is('option')) {
              ...
              selectOptions.each(function(el) {
                let optionEl = _this70._appendOptionWithIcon(_this70.$el, el, 'optgroup-option');
                _this70._addOptionToValueDict(el, optionEl);
              });
            }
          });
        ...
        if (!this.el.disabled) {
          ...
          dropdownOptions.onOpenEnd = function(el) {
            let selectedOption = $(_this70.dropdownOptions).find('.selected').first();
            if (_this70.dropdown.isScrollable && selectedOption.length) {
              let scrollOffset = selectedOption[0].getBoundingClientRect().top - _this70.dropdownOptions.getBoundingClientRect().top; // scroll to selected option
...
(function($, anim) {
  ...
  let Range = function(_Component21) {
    ...
    function Range(el, options) {
      ...
      let _this71 = _possibleConstructorReturn(this, (Range.__proto__ || Object.getPrototypeOf(Range)).call(this, Range, el, options));
